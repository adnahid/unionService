...
public class Reporter extends AppCompatActivity {
    RecyclerView reporterRecyclerView;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reporterRecyclerView = findViewById(R.id.reporterRecyclerView);
        DetailsTable();
        ...
        reporterRecyclerView.setAdapter(reporterAdapter);
        reporterRecyclerView.setLayoutManager(new LinearLayoutManager(Reporter.this));


    }

    private class ReporterAdapter extends RecyclerView.Adapter{
...
//            return new nativeHolder(view);
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            readHolder.advocateCardView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(Reporter.this, LRDWProfileActivity.class);
