...
public class NewOposum extends AppCompatActivity {
    RecyclerView NewOposumRecyclerView;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_oposum);
        NewOposumRecyclerView  = findViewById(R.id.NewOposumRecyclerView);
        ...
        DetailsTable();
        NewOposumAdapter newOposumAdapter = new NewOposumAdapter();
        NewOposumRecyclerView.setAdapter(newOposumAdapter);
        NewOposumRecyclerView.setLayoutManager(new LinearLayoutManager(NewOposum.this));


    }
    private class NewOposumAdapter extends RecyclerView.Adapter{
...
//            readHolder.dcImage.setImageBitmap(circleBitmap);
            ...
            readHolder.dcCardView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(NewOposum.this, DoctorProfile.class);
