...
public class ABpositive extends Fragment {
    RecyclerView abPositiveRecyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myview = inflater.inflate(R.layout.fragment_a_bpositive, container, false);

        abPositiveRecyclerView = myview.findViewById(R.id.abPositiveRecyclerView);

        DetailsTable();
        APositiveAdapter aPositiveAdapter = new APositiveAdapter();
        abPositiveRecyclerView.setAdapter(aPositiveAdapter);
        abPositiveRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
    ...
    private class APositiveAdapter extends RecyclerView.Adapter{
