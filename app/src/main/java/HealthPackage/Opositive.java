...
public class Opositive extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myview = inflater.inflate(R.layout.fragment_opositive, container, false);

        oPositiveRecyclerView = myview.findViewById(R.id.oPositiveRecyclerView);

        DetailsTable();
        OposAdapter oposAdapter = new OposAdapter();
        oPositiveRecyclerView.setAdapter(oposAdapter);
        oPositiveRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));


        return myview;
    }

    private class OposAdapter extends RecyclerView.Adapter{
