...
public class ANegitive extends Fragment {

    RecyclerView ANegetiveRecyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myview = inflater.inflate(R.layout.fragment_a_negitive, container, false);
        ANegetiveRecyclerView = myview.findViewById(R.id.ANegetiveRecyclerView);

        DetailsTable();
        Anegative anegative = new Anegative();
        ANegetiveRecyclerView.setAdapter(anegative);
        ANegetiveRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));


        return myview;
    }

    private class Anegative extends RecyclerView.Adapter{
