...
public class BNegitive extends Fragment {



    RecyclerView BNegetiveRecyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myview = inflater.inflate(R.layout.fragment_b_negitive, container, false);
        BNegetiveRecyclerView = myview.findViewById(R.id.BNegetiveRecyclerView);

        DetailsTable();
        BnegAdapter bnegAdapter = new BnegAdapter();
        BNegetiveRecyclerView.setAdapter(bnegAdapter);
        BNegetiveRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
    ...
    private class BnegAdapter extends RecyclerView.Adapter{
