...
public class Bpositive extends Fragment {

    RecyclerView BpositiveRecyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myview = inflater.inflate(R.layout.fragment_bpositive, container, false);

        BpositiveRecyclerView = myview.findViewById(R.id.BpositiveRecyclerView);

        DetailsTable();
        BpositiveAdapter bpositiveAdapter = new BpositiveAdapter();
        BpositiveRecyclerView.setAdapter(bpositiveAdapter);
        BpositiveRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
    ...
    private class BpositiveAdapter extends RecyclerView.Adapter{
