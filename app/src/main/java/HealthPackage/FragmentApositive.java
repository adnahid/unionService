...
public class FragmentApositive extends Fragment {

    RecyclerView aPossitiveRecyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        aPossitiveRecyclerView = myView.findViewById(R.id.aPossitiveRecyclerView);

        DetailsTable();
        ApositiveAdapter apositiveAdapter = new ApositiveAdapter();
        aPossitiveRecyclerView.setAdapter(apositiveAdapter);
        aPossitiveRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
