...
public class ABNegitive extends Fragment {

    RecyclerView abNegetiveRecyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myview = inflater.inflate(R.layout.fragment_a_b_negitive, container, false);

        abNegetiveRecyclerView = myview.findViewById(R.id.abNegetiveRecyclerView);

        DetailsTable();
        AbnegAdapter abnegAdapter = new AbnegAdapter();
        abNegetiveRecyclerView.setAdapter(abnegAdapter);
        abNegetiveRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));


        return myview;
    }

    private class AbnegAdapter extends RecyclerView.Adapter{
