...
public class DecoumtWritter extends AppCompatActivity {
    RecyclerView decoumentRecyclerView;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_decoumt_writter);
        toolbar = findViewById(R.id.toolbar);
        decoumentRecyclerView = findViewById(R.id.decoumentRecyclerView);
        DetailsTable();
        ...
        DecumentAdapter decumentAdapter = new DecumentAdapter();
        decoumentRecyclerView.setAdapter(decumentAdapter);
        decoumentRecyclerView.setLayoutManager(new LinearLayoutManager(DecoumtWritter.this));


    }

    private class DecumentAdapter extends RecyclerView.Adapter{
...
//            return new nativeHolder(view);
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            readHolder.advocateCardView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(DecoumtWritter.this, LRDWProfileActivity.class);
